...
public class VistaArtista extends Fragment {
    ...
    private AdaptadorTrabajos adaptador;
    ...
    public static VistaArtista newInstance() {
        return new VistaArtista();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.vista_artista_fragment, container, false);

        rv = (RecyclerView)root.findViewById(R.id.trabajosArti);
        db = new BDExposiciones(getContext());
        tx = (TextView)root.findViewById(R.id.textViewNombreArti);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        trabajos = new ArrayList<Trabajos>();
        String[] arti = new String[1];
        arti[0] = sp.getString("artiKey", "");

        Artista at = db.buscarListaArtistas(arti);
        ...
        adaptador.setOnItemClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(root).navigate(R.id.verTrabajo);
